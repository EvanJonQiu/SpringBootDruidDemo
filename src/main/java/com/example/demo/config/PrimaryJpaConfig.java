...
public class PrimaryJpaConfig {
	...
	public static final String REPOSITORY_PACKAGE = "com.example.demo.repository.primary";
	private static final String ENTITY_PACKAGE = "com.example.demo.model.primary";
